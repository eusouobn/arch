...
pacman -S xorg-server xorg-xinit xterm xf86-video-amdgpu networkmanager xfce4 lightdm lightdm-gtk-greeter pipewire pipewire-alsa pipewire-jack pipewire-pulse wireplumber xdg-user-dirs --noconfirm
